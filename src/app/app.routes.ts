  ...
  },
  {
    ...
    children: [
     // { path: 'dashboard', loadComponent: () => import('./features/admin/dashboard/dashboard.component').then(m => m.DashboardComponent) },
      ...
      { path: 'employees/new', loadComponent: () => import('./features/admin/employees/employee-list/employee-form/employee-form.component').then(m => m.EmployeeFormComponent) },
      { path: 'employees/edit/:id', loadComponent: () => import('./features/admin/employees/employee-list/employee-form/employee-form.component').then(m => m.EmployeeFormComponent) },
